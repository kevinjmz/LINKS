...
class InputAnimationView : UIView, CAAnimationDelegate {
	...
	func addInputAnimation(beginTime: CFTimeInterval, fillMode: String, removedOnCompletion: Bool, completion: ((Bool) -> Void)?) {
		...
		self.viewsByName["lines 2_mask__root"]?.layer.add(lines2Mask2TranslationYAnimation, forKey:"InputAnimation_TranslationY")

		let numpadOpacityAnimation = CAKeyframeAnimation(keyPath: "opacity")
		numpadOpacityAnimation.duration = 1.400
		numpadOpacityAnimation.values = [0.000, 0.000, 1.000, 1.000] as [Float]
		numpadOpacityAnimation.keyTimes = [0.000, 0.857, 0.911, 1.000] as [NSNumber]
		...
		self.viewsByName["numpad__root"]?.layer.add(numpadOpacityAnimation, forKey:"InputAnimation_Opacity")
		...
		lines2MaskScaleYAnimation.values = [0.135, 0.135, 0.877, 0.015, 0.015] as [Float]
		lines2MaskScaleYAnimation.keyTimes = [0.000, 0.786, 0.821, 0.839, 1.000] as [NSNumber]
		lines2MaskScaleYAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming, linearTiming]
		...
		self.viewsByName["lines_2_mask__yScale"]?.layer.add(lines2MaskScaleYAnimation, forKey:"InputAnimation_ScaleY")
		...
		lines2MaskTranslationXAnimation.values = [0.000, 0.000, 29.443, 130.703, 164.916, 164.916] as [Float]
		lines2MaskTranslationXAnimation.keyTimes = [0.000, 0.786, 0.804, 0.821, 0.839, 1.000] as [NSNumber]
		lines2MaskTranslationXAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming, linearTiming, linearTiming]
		...
		self.viewsByName["lines_2_mask__root"]?.layer.add(lines2MaskTranslationXAnimation, forKey:"InputAnimation_TranslationX")
		...
		lines2MaskTranslationYAnimation.values = [0.000, 0.000, 61.793, 256.933, 328.738, 328.738] as [Float]
		lines2MaskTranslationYAnimation.keyTimes = [0.000, 0.786, 0.804, 0.821, 0.839, 1.000] as [NSNumber]
		lines2MaskTranslationYAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming, linearTiming, linearTiming]
		...
		self.viewsByName["lines_2_mask__root"]?.layer.add(lines2MaskTranslationYAnimation, forKey:"InputAnimation_TranslationY")
		...
		input2OpacityAnimation.keyTimes = [0.000, 0.821, 0.875, 1.000] as [NSNumber]
	...
	func removeInputAnimation() {
		...
		self.viewsByName["home_icon__root"]?.layer.removeAnimation(forKey: "InputAnimation_Opacity")
		self.viewsByName["home_icon__root"]?.layer.removeAnimation(forKey: "InputAnimation_TranslationY")
		...
		self.viewsByName["numpad__root"]?.layer.removeAnimation(forKey: "InputAnimation_Opacity")
	...
	func addInputAnimationReversedAnimation(beginTime: CFTimeInterval, fillMode: String, removedOnCompletion: Bool, completion: ((Bool) -> Void)?) {
		...
		let input1OpacityAnimation = CAKeyframeAnimation(keyPath: "opacity")
		input1OpacityAnimation.duration = 1.400
		input1OpacityAnimation.values = [1.000, 1.000, 0.000, 0.000] as [Float]
		...
		homeIconOpacityAnimation.keyTimes = [0.000, 0.071, 0.125, 1.000] as [NSNumber]
		homeIconOpacityAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming]
		homeIconOpacityAnimation.beginTime = beginTime
		homeIconOpacityAnimation.fillMode = fillMode
		homeIconOpacityAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["home_icon__root"]?.layer.add(homeIconOpacityAnimation, forKey:"InputAnimation_reversed_Opacity")

		let homeIconTranslationYAnimation = CAKeyframeAnimation(keyPath: "transform.translation.y")
		homeIconTranslationYAnimation.duration = 1.400
		homeIconTranslationYAnimation.values = [1.000, 1.000, 0.000] as [Float]
		homeIconTranslationYAnimation.keyTimes = [0.000, 0.314, 1.000] as [NSNumber]
		homeIconTranslationYAnimation.timingFunctions = [linearTiming, linearTiming]
		homeIconTranslationYAnimation.beginTime = beginTime
		homeIconTranslationYAnimation.fillMode = fillMode
		homeIconTranslationYAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["home_icon__root"]?.layer.add(homeIconTranslationYAnimation, forKey:"InputAnimation_reversed_TranslationY")

		let lines2Mask2ScaleXAnimation = CAKeyframeAnimation(keyPath: "transform.scale.x")
		lines2Mask2ScaleXAnimation.duration = 1.400
		lines2Mask2ScaleXAnimation.values = [0.371, 0.371, 0.254, 0.254] as [Float]
		lines2Mask2ScaleXAnimation.keyTimes = [0.000, 0.268, 0.304, 1.000] as [NSNumber]
		lines2Mask2ScaleXAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming]
		lines2Mask2ScaleXAnimation.beginTime = beginTime
		lines2Mask2ScaleXAnimation.fillMode = fillMode
		lines2Mask2ScaleXAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["lines 2_mask__xScale"]?.layer.add(lines2Mask2ScaleXAnimation, forKey:"InputAnimation_reversed_ScaleX")

		let lines2Mask2ScaleYAnimation = CAKeyframeAnimation(keyPath: "transform.scale.y")
		lines2Mask2ScaleYAnimation.duration = 1.400
		lines2Mask2ScaleYAnimation.values = [0.005, 0.005, 0.383, 0.030, 0.507, 0.314, 0.002, 0.002] as [Float]
		lines2Mask2ScaleYAnimation.keyTimes = [0.000, 0.071, 0.089, 0.143, 0.179, 0.268, 0.304, 1.000] as [NSNumber]
		lines2Mask2ScaleYAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming, linearTiming, linearTiming, linearTiming, linearTiming]
		lines2Mask2ScaleYAnimation.beginTime = beginTime
		lines2Mask2ScaleYAnimation.fillMode = fillMode
		lines2Mask2ScaleYAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["lines 2_mask__yScale"]?.layer.add(lines2Mask2ScaleYAnimation, forKey:"InputAnimation_reversed_ScaleY")

		let lines2Mask2TranslationXAnimation = CAKeyframeAnimation(keyPath: "transform.translation.x")
		lines2Mask2TranslationXAnimation.duration = 1.400
		lines2Mask2TranslationXAnimation.values = [402.380, 402.380, 430.662, 512.510, 538.938, 538.938, -374.348, -374.348, -338.610, -248.761, -194.310, -68.970, -26.068, 0.000, 0.000] as [Float]
		lines2Mask2TranslationXAnimation.keyTimes = [0.000, 0.071, 0.089, 0.107, 0.125, 0.125, 0.126, 0.143, 0.161, 0.179, 0.214, 0.232, 0.268, 0.304, 1.000] as [NSNumber]
		lines2Mask2TranslationXAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming, linearTiming, instantTiming, instantTiming, linearTiming, linearTiming, linearTiming, linearTiming, linearTiming, linearTiming, linearTiming, linearTiming]
		lines2Mask2TranslationXAnimation.beginTime = beginTime
		lines2Mask2TranslationXAnimation.fillMode = fillMode
		lines2Mask2TranslationXAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["lines 2_mask__root"]?.layer.add(lines2Mask2TranslationXAnimation, forKey:"InputAnimation_reversed_TranslationX")

		let lines2Mask2TranslationYAnimation = CAKeyframeAnimation(keyPath: "transform.translation.y")
		lines2Mask2TranslationYAnimation.duration = 1.400
		lines2Mask2TranslationYAnimation.values = [-532.312, -532.312, -511.971, -425.623, -406.615, -406.615, -292.417, -292.417, -266.713, -214.255, -168.902, -60.023, -16.302, 0.000, 0.000] as [Float]
		lines2Mask2TranslationYAnimation.keyTimes = [0.000, 0.071, 0.089, 0.107, 0.125, 0.125, 0.126, 0.143, 0.161, 0.179, 0.214, 0.232, 0.268, 0.304, 1.000] as [NSNumber]
		lines2Mask2TranslationYAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming, linearTiming, instantTiming, instantTiming, linearTiming, linearTiming, linearTiming, linearTiming, linearTiming, linearTiming, linearTiming, linearTiming]
		lines2Mask2TranslationYAnimation.beginTime = beginTime
		lines2Mask2TranslationYAnimation.fillMode = fillMode
		lines2Mask2TranslationYAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["lines 2_mask__root"]?.layer.add(lines2Mask2TranslationYAnimation, forKey:"InputAnimation_reversed_TranslationY")

		let numpadOpacityAnimation = CAKeyframeAnimation(keyPath: "opacity")
		numpadOpacityAnimation.duration = 1.400
		numpadOpacityAnimation.values = [1.000, 1.000, 0.000, 0.000] as [Float]
		numpadOpacityAnimation.keyTimes = [0.000, 0.089, 0.143, 1.000] as [NSNumber]
		numpadOpacityAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming]
		numpadOpacityAnimation.beginTime = beginTime
		numpadOpacityAnimation.fillMode = fillMode
		numpadOpacityAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["numpad__root"]?.layer.add(numpadOpacityAnimation, forKey:"InputAnimation_reversed_Opacity")
		...
		let lines2MaskScaleYAnimation = CAKeyframeAnimation(keyPath: "transform.scale.y")
		lines2MaskScaleYAnimation.duration = 1.400
		lines2MaskScaleYAnimation.values = [0.015, 0.015, 0.877, 0.135, 0.135] as [Float]
		lines2MaskScaleYAnimation.keyTimes = [0.000, 0.161, 0.179, 0.214, 1.000] as [NSNumber]
		lines2MaskScaleYAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming, linearTiming]
		lines2MaskScaleYAnimation.beginTime = beginTime
		lines2MaskScaleYAnimation.fillMode = fillMode
		lines2MaskScaleYAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["lines_2_mask__yScale"]?.layer.add(lines2MaskScaleYAnimation, forKey:"InputAnimation_reversed_ScaleY")

		let lines2MaskTranslationXAnimation = CAKeyframeAnimation(keyPath: "transform.translation.x")
		lines2MaskTranslationXAnimation.duration = 1.400
		lines2MaskTranslationXAnimation.values = [164.916, 164.916, 130.703, 29.443, 0.000, 0.000] as [Float]
		lines2MaskTranslationXAnimation.keyTimes = [0.000, 0.161, 0.179, 0.196, 0.214, 1.000] as [NSNumber]
		lines2MaskTranslationXAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming, linearTiming, linearTiming]
		lines2MaskTranslationXAnimation.beginTime = beginTime
		lines2MaskTranslationXAnimation.fillMode = fillMode
		lines2MaskTranslationXAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["lines_2_mask__root"]?.layer.add(lines2MaskTranslationXAnimation, forKey:"InputAnimation_reversed_TranslationX")

		let lines2MaskTranslationYAnimation = CAKeyframeAnimation(keyPath: "transform.translation.y")
		lines2MaskTranslationYAnimation.duration = 1.400
		lines2MaskTranslationYAnimation.values = [328.738, 328.738, 256.933, 61.793, 0.000, 0.000] as [Float]
		lines2MaskTranslationYAnimation.keyTimes = [0.000, 0.161, 0.179, 0.196, 0.214, 1.000] as [NSNumber]
		lines2MaskTranslationYAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming, linearTiming, linearTiming]
		lines2MaskTranslationYAnimation.beginTime = beginTime
		lines2MaskTranslationYAnimation.fillMode = fillMode
		lines2MaskTranslationYAnimation.isRemovedOnCompletion = removedOnCompletion
		self.viewsByName["lines_2_mask__root"]?.layer.add(lines2MaskTranslationYAnimation, forKey:"InputAnimation_reversed_TranslationY")
		...
		input2OpacityAnimation.keyTimes = [0.000, 0.125, 0.179, 1.000] as [NSNumber]
		input2OpacityAnimation.timingFunctions = [linearTiming, linearTiming, linearTiming]
		input2OpacityAnimation.beginTime = beginTime
		input2OpacityAnimation.fillMode = fillMode
		input2OpacityAnimation.isRemovedOnCompletion = removedOnCompletion
	...
	func removeInputAnimationReversedAnimation() {
		...
		self.viewsByName["home_icon__root"]?.layer.removeAnimation(forKey: "InputAnimation_reversed_Opacity")
		self.viewsByName["home_icon__root"]?.layer.removeAnimation(forKey: "InputAnimation_reversed_TranslationY")
		...
		self.viewsByName["numpad__root"]?.layer.removeAnimation(forKey: "InputAnimation_reversed_Opacity")
